...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("BurnCoins"));
    case mBTC: return QString(QObject::tr("Milli-BurnCoins (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-BurnCoins (1 / 1,000,000)"));
    default: return QString("???");
    }
}
